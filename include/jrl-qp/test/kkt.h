 ...
 */
void JRLQP_DLLAPI checkDimensions(const MatrixConstRef & G,
 ...
 * When transposedC is true, the constraints read bl <= C^T x <= bu
 */
void JRLQP_DLLAPI checkDimensions(const VectorConstRef & x,
 ...
 */
bool JRLQP_DLLAPI testKKT(const VectorConstRef & x,
                          const VectorConstRef & u,
                          const MatrixConstRef & G,
                          const VectorConstRef & a,
                          const MatrixConstRef & C,
